						...
						<div class="nav-collapse nav-collapse_ collapse row-fluid ">
							<div class="clearfix">
								...
								<select class="select-menu" style="display: inline-block;"><option
									...
									<option value="#">––Analyst relations</option>
									<option value="#">––Awards</option>
									<option value="#">–––Green enterprise</option>
									<option value="#">–––Legal Information</option>
									<option value="#">–––Management team</option>
									<option value="#">–––Press &amp; Media</option>
									<option value="#">––Company information</option>
									<option value="#">––Consultants</option>
									<option value="#">––Events</option>
									<option value="#">Products &amp; Services</option>
									<option value="#">Support</option>
									<option value="#">Contacts</option></select>
		...
		<div class="container">
			<div class="row">
				<article class="span5">
					...
					<p>Customer satisfication and employee empowerment in tandem
						...
						forward.To work together with our customers to help them achieve
						their goals.Our success lies in your success.</p>


					<h4>Values</h4>

					<p>Honesty,integrity,dedication and commiyment will always be
						our priority and trademark.Dignity and respect to all will be our
						guiding principles in every dealing with customers and suppliers.</p>
				...
				<article class="span7">
					...
					<p>Arya Offset Pvt. LTd., Coimbatore, with affluent experience
						...
						family-held, ARYA has grown into a print production house that is
			...
			<div class="row-fluid">
				...
				<div class="span4">
					...
					Everyone will be actively involved in the continuous improvement of
					...
					consciousness will be inculcated. <br> <br>
					<h4>Responsibility for actions</h4>
					Our business will be conducted in such a way that organizationally
					...
					actions and decisions should be taken accordingly.
				...
				<div class="span4">
					...
					All employees will be treated with respect and dignity,recognition
					...
					dignity,lending each other a helping hand whenever they can.<br>
					<br>

					<h4>Education & empowerment of employees</h4>
					We will continuously strive to upgrade employee skills by imparing
					education,offering training and encouraging varied skills.ct that
			...
			<div class="row-fluid">
				...
				<div class="span4">
					...
					Arya is equipped with the latest technology and equipment to ensure
				...
				<div class="span4">
					<h4>Our Team</h4>
					We enjoy transforming your vision into the final produst,and have
			...
			<div class="row-fluid">
				...
				<div class="span4">
					<br> <br> <br>Arya is a one-stop shop that can
					handle all your requirements from structural design to production
					to distribution.having the entire operation in-house ensures tight
					control over quality and faster turnaround.
				</div>
				<div class="span4">
			...
			<div class="row-fluid">
				...
				<div class="span4">
					...
					When quality is the keystone, quality accerdiations are bound to
					fall in place. The Arya printing press was born out of the need to
					provide quality print sevices and hence it went about setting up a
					successfully run business model that became it become an ISO
					requirement. Key features of or quality plicy are:* To deliver end
					to end print solutions that go beyond the industry steeotypes,
					quality becomes The Bottom Line. * Transparency of process no
					hidden costs and total clarity among our clients * To have
					unparallel Customer care and support practices, to ensure customers
					goodwill. *constantly upgrade the print technolgy and machinery of
					the printing press facility * Recruiting the best manpower and
					consistently provide induction and training to the trends of the
					print technology * To nurture the best practices of quality
					management
				</div>
				<div class="span4">
