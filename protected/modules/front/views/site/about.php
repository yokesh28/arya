		...
		<div class="align container">
			<div class="row">
				...
				<article class="span7">
					...
					<p>Arya Offset Pvt. LTd., Coimbatore, with affluent experience
						...
						in this field. Our team of creative professionals strives to think
			...
			<div class=" row-fluid">
				...
				<div class="span4">
					...
					actions and decisions should be taken accordingly.</p>
				...
				<div class="span4">
					...
					experience exceeds your expectations.</p>
			...
			<div class=" row-fluid">
				...
				<div class="span4">
					...
					minimum dependance on outsourcing makes us a reliable partner.</p>
				</div>
				<div class="span4">
			...
			<div class="row-fluid">
				...
				<div class="span4">
					<br> <br> <br><p>Arya is a one-stop shop that can
					...
					control over quality and faster turnaround.</p>
				</div>
				<div class="span4">
			...
			<div class="row-fluid">
				...
				<div class="span4">
					...
					requirement. Key features of or quality policy are: *To deliver end
					to end print solutions that go beyond the industry stereotypes,
					...
					goodwill. *Constantly upgrade the print technology and machinery of
