							...
							<div class="view">
								...
								<form id="id2">
									<label><b>Quantity:</b> </label> <select name="quantity1"><option>500nos</option>
										...
										name="type1"><option>Single Side</option>
										<option>Front&Back</option>
							...
							<div class="view">
								...
								<form id="id3">
									<label><b>Quantity:</b> </label> <select name="quantity2"><option>500nos</option>
										...
										name="type2"><option>Single Side</option>
										<option>Front&Back</option>
							...
							<div class="view">
								...
								<form id="id4">
									<label><b>Quantity:</b> </label> <select name="quantity3"><option>500nos</option>
										...
										name="type3"><option>Per Side</option>
									...
									<div class="view">
										...
										<form id="id9">
											<label><b>Quantity:</b> </label> <select name="quantity4"><option>500nos</option>
												...
												name="type4"><option>Single Side</option>
												<option>extra</option>
									...
									<div class="view">
										...
										<form id="id10">
											<label><b>Quantity:</b> </label> <select name="quantity5"><option>10pads</option>
												...
												name="type5"><option>Single Side</option>
												<option>extra</option>
												<option>Per Side</option>
												<option>Knurling</option>
												<option>envelope</option>
									...
									<div class="view">
										...
										<form id="id13">
											<label><b>Quantity:</b> </label> <select name="quantity8">
												...
												name="type8"><option>SingleSide</option>
												<option>front&back</option>

											</select><br> <br> <label><b>Size :</b> </label><select
												name="size"><option>170gsm - 210x280mm</option>
