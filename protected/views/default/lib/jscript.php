...
<script type="text/javascript" src="<?php echo Yii::app()->theme->baseUrl;?>/js/jquery.mobilemenu.js"></script>
...
<script type="text/javascript" async="" src="<?php echo Yii::app()->theme->baseUrl;?>/js/ga.js"></script>