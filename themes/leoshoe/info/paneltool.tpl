  ...
  <form action="{$content_dir}" method="get">
    <div style="min-height: 300px; width: 200px; left: 0px;" class="pn-content " id="toolspanelcontent">
      ...
      <div id="template_direction">
        ...
        <select name="layout">
          <option value="-lcr"{if $LEO_LAYOUT_DIRECTION == '-lcr'} selected="selected"{/if}>Content - Left</option>
          <option value="-rcl"{if $LEO_LAYOUT_DIRECTION == '-rcl'} selected="selected"{/if}>Left - Content</option>
        </select>
