	...
	{foreach from=$products item=product name=products}
		<li class="ui-block-{if $smarty.foreach.products.index % 2}b{else}a{/if} product-list-row">
			<a href="{$product.link|escape:'htmlall':'UTF-8'}" data-ajax="false">
				<div class="product_img_wrapper"><img class="ui-li-thumb" src="{$link->getImageLink($product.link_rewrite, $product.id_image, 'home_leoshoe')}" alt="{$product.legend|escape:'htmlall':'UTF-8'}" /></div>
