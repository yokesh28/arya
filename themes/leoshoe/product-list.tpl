			...
			<div class="center_block">
			  ...
			  <div class="add_view">
				...
				{if isset($comparator_max_item) && $comparator_max_item}
					<p class="compare">Click to Compare
				...
				{/if}
					...
					{if ($product.allow_oosp || $product.quantity > 0)}
						...
						{if isset($static_token)}
							<a class="button ajax_add_to_cart_button exclusive" rel="ajax_id_product_{$product.id_product|intval}" href="{$link->getPageLink('cart',false, NULL, "add&amp;id_product={$product.id_product|intval}&amp;token={$static_token}", true)}" title="{l s='Add to cart'}"><span></span>{l s='Shop now'}</a>
						{else}
